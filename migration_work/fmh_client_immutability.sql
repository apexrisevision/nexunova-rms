...
-- Generated 2026-07-29T11:52:28.481Z by migration_work/fmh_backfill_gen.js
...
CREATE TEMP TABLE _cli_before AS
  SELECT id, client_code, md5(c::text) AS rowhash, updated_at
  FROM clients c WHERE id IN ('137e9d4f-9815-4485-b072-9116cab267a0','fb0c1534-6788-4a4a-865c-370fac5fb6c4','942d2edd-318c-4a91-989a-109c84c8def8','32a77d84-7ce6-4aaf-95a1-2b503ad5878b','77d1b4b3-b93a-4cb6-b039-d97fc89251af');
