-- Portfolio Summary: split Balance into Current Receivable (as-of-date outstanding,
-- = get_recovery_position.closing, the same field Aging / Recovery Position use) and
-- Balance to Project End (net - received). Append-only CREATE OR REPLACE.
