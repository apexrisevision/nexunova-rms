-- ============================================================================
-- NEXUNOVA RMS — board: include unit BASE_PRICE so the sales person can quote
-- the rate (per-sqft) and total price on the card and in the reserve form,
-- without checking a separate price list. 2026-06-16. Additive.
-- Re-creates get_availability_board (privacy + floor sort + sold_by + area
-- preserved), adding 'base_price' to each unit object. Per-sqft rate is derived
-- on the client as base_price / area.
-- ============================================================================
