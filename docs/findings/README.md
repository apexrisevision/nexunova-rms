...
| [2026-09-05-E](2026-09-05-E-bank-literal-never-matches.md) | "Bank Received" reads PKR 0 on every cancellation and every transfer | `js/pages/cancellation.js:304`, `js/pages/transfers.js:415` — **every tenant, every sale** | **Triaged 2026-09-05 — safe to fix quietly.** Exposure measured (§3b): 21 live cancellations saw the panel, 0 transfers outside ZZTEST, and no money decision was recorded on any of them. |
