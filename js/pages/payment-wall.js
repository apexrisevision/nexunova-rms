...
const PW = {
  ...
  async _submitProof() {
    ...
    try {
      ...
      // Store the object PATH (private bucket) — readers generate a short-lived
      // signed URL on demand via createSignedUrl. (Old rows stored a getPublicUrl
      // string; the super-admin reader handles both forms.)
  ...
  _renderExpired(subStatus) {
    ...
    this._setBody(`
      ...
      <a href="mailto:sales@nexunova.com?subject=Renew%20RMS%20Subscription&body=${waText}" class="pw2-wa-btn" style="margin-top:28px">
  ...
  _renderWaiting() {
    ...
    this._setBody(`
      ...
      <a href="mailto:support@nexunova.com?subject=Payment%20Proof%20Submitted&body=${waText}" class="pw2-wa-btn" style="margin-top:20px">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
