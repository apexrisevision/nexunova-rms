      ...
      <div class="cb">
        <div style="display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:12px">
          ...
          <div style="display:flex;gap:7px;flex-wrap:wrap" class="no-p">
            ...
            ${isSold?`<button class="btn btn-gh btn-sm" onclick="printSaleAgreement('${unitId}')">📋 Agreement</button>`:''}
            ${isSold&&actualPending(u)>0?`<button class="btn btn-r btn-sm" onclick="printDemandLetter('${unitId}')">⚠ Demand</button>`:''}
            ${isA?`<button class="btn btn-gh btn-sm" onclick="printUnitReport('${unitId}')">🖨 Report</button>`:''}
