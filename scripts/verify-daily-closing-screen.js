...
(async () => {
  ...
  try {
    ...
    // The S8 dashboard tile was DELETED on 2026-09-07. v1 of NexuFinance has
    // no tile: keeping it meant keeping a shell adapter inside RMS's dashboard
    // reaching for RMS globals, which is the thing the separation is leaving.
    // Five sections and their assertions went with it.
